                            ...
                            foreach($cats as $cat) {
                                echo "<div class='cat'>";
                                    echo "<div class='hidden-buttons'>";
                                        echo "<a href='categories.php?do=Edit&catid=" . $cat['ID'] . "' class='btn btn-sx btn-primary'><i class='fa fa-edit'></i> Edit</a>";
                                        echo "<a href='categories.php?do=Delete&catid=" . $cat['ID'] . "' class='confirm btn btn-sx btn-danger'><i class='fa fa-times'></i> Delete</a>";
                                    echo "</div>";
                                    echo "<h3>" . $cat["Name"] . "</h3>";
                                    echo "<div class='full-view'>";
                                        echo "<p>"; if ($cat["Description"] == "") { echo "This Category has no description"; } else { echo $cat["Description"]; }  echo "</p>";
                                        if ($cat["Visibility"] == 1) { echo "<span class='visibility'><i class='fa fa-eye'></i> Hidden</span>"; }
                                        if ($cat["Allow_Comment"] == 1) { echo "<span class='commenting'><i class='fa fa-times'></i> Comment Disabled</span>"; }
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($check == 1) {
                        ...
                        $stmt = $con->prepare("INSERT INTO 
                                    ...
                                    VALUES(:znmae, :zdesc, :zparent, :zorder, :zvisible, :zcomment, :zads)");
                        $stmt->execute(array(
                    ...
                    <form class="form-horizontal" action="?do=Update" method="POST">
                        ...
                        <div class="form-group form-group-lg">
                            <div class="row">
                                <label class="col-sm-2 control-label">Name</label>
                                <div class="col-sm-10 col-md-4">
                                    <input type="text" name="name" class="form-control" autocomplete="off" placeholder="Name Of The Category" required="required" value="<?php echo $cat['Name'] ?>">
                                </div>
                            </div>
                        </div>
                        <!-- End Name Field-->
