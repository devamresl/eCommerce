...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <img class="img-responsive center-block img-thumbnail" src="01.png" alt="">
            </div>
                    ...
                    <li class="tags-items">
                        ...
                        <?php
                            ...
                            foreach ($allTags as $tag) {
                                $tag = str_replace(" ", "", $tag);
                                $lawertag = strtolower($tag);
                                if (!empty($tag)) {
                                    echo "<a href='tags.php?name={$lawertag}'>" . $tag . "</a> | ";
                                }
                            }
                        ?>
                    </li>
                ...
                <div class="comment-box">
                    <div class="row">
                        <div class="col-sm-2 text-center">
                            <img class="img-responsive img-thumbnail img-circle center-block" src="01.png" alt="">
